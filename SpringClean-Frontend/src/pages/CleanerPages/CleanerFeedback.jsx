...
import HomeBar from "../../components/Navbar/NavBarCompany_Cleaner";
...
const CleanerFeedback = () => {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:8080/api/reviews/cleaner/${cleaner.cleanerId}`)
            .then((res) => res.json())
            .then((data) => {
                console.log("Fetched reviews:", data, cleaner.cleanerId);
                setReviews(data);
            })
            .catch((err) => console.error("Error fetching reviews:", err));
    }, [cleaner]);  // <-- always a fixed array with 1 item
...
export default CleanerFeedback;
